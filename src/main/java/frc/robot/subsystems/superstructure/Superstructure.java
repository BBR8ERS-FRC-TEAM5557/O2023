...
public class Superstructure {
    ...
    public static Command setSuperstructureScore(Supplier<NodeLevel> level,
        ...
        return Commands.either(
                Commands.select(
                        Map.of(NodeLevel.HYBRID, setSuperstructureGoal(SuperstructureGoal.L1_SCORE),
                                NodeLevel.MID, setSuperstructureGoal(SuperstructureGoal.L2_CONE),
                                NodeLevel.HIGH, setSuperstructureGoal(SuperstructureGoal.L3_CONE)),
                        () -> level.get()),
                Commands.select(
                        Map.of(NodeLevel.HYBRID, setSuperstructureGoal(SuperstructureGoal.L1_SCORE),
                                NodeLevel.MID, setSuperstructureGoal(SuperstructureGoal.L2_CUBE),
                                NodeLevel.HIGH, setSuperstructureGoal(SuperstructureGoal.L3_CUBE)),
                        () -> level.get()),
    ...
    public static enum SuperstructureGoal {
        ...
        L2_CONE(12.0, 200.0), L2_CUBE(12.0, 200.0),

        L3_CONE(20.0, 200.0), L3_CUBE(20.0, 200.0);
